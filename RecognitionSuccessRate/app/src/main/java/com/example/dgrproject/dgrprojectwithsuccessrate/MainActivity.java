...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.dgrproject.dgrprojectwithsuccessrate.R.layout.activity_main);

        textview1 = (TextView) findViewById(com.example.dgrproject.dgrprojectwithsuccessrate.R.id.textview1);
    ...
    public void displayOnScreen(final float successRate) {
        textview1.setText(Float.toString(successRate));
