...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithsuccessrate_NativeClass_findContourAndCropping(
        JNIEnv *env,
        jobject instance,
        jlong addrSrc,
        jlong addrDst) {
...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithsuccessrate_NativeClass_scalingWithAspectRatio(
        JNIEnv *env,
        jobject instance,
        jlong image,
        jint targetWidth,
...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithsuccessrate_NativeClass_sobelFilter(JNIEnv *env,
                                                                              jobject instance,
                                                                              jlong addrSrc,
                                                                              jlong addrDst) {
...
void JNICALL
Java_com_example_dgrproject_dgrprojectwithsuccessrate_NativeClass_lbpWithHistogram(JNIEnv *env,
                                                                                   jobject instance,
                                                                                   jlong addrSrc,
                                                                                   jlong addrDst) {
    Mat &src = *(Mat *) addrSrc;
...
float JNICALL
Java_com_example_dgrproject_dgrprojectwithsuccessrate_NativeClass_svm(JNIEnv *env, jobject instance,
    ...
    for (int z = 0; z < trainimgs.size(); z++) {
        ...
        if (digitClassNumber == 15) { // her örnekten 4 resmimiz olduğu için
            digitClassNumber = 0;
        }
    ...
    svm->setC(1);
    svm->setGamma(0.5);
    svm->setTermCriteria(TermCriteria(TermCriteria::MAX_ITER, 75, 1e-6));
